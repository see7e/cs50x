...
<details>
<summary>Keeywords, lookup in <a href="./src/transcripts/lecture0.md">transcript</a></summary>
...
- Transistors
- Swiches
- Base-10 ( ... 10<sup>2</sup> 10<sup>1</sup> 10<sup>0</sup>)
- [Bites](#bites)
...
- [Lecture 0](#lecture-0)
  ...
  - [Problem Set 0 - Scratch](#problem-set-0---scratch)
...
## Bites
cada casa do bite consegue "contar" até 255, onde cada casa representa um intervalo de valores:
...
## [Problem Set 0 - Scratch](./problem_set0.md)